...
#define LANG_ConfLedError "Si la LED bleue reste allumée, c'est que le réglage a échoué. Reconnectez vous alors au réseau WiFi '{#HOSTNAME#}' pour corriger les paramètres."
...
#define LANG_OTASUCCESS4 "Si la LED bleue reste allumée, la configuration a échoué et vous devrez refaire la connexion avec le réseau WiFi '{#HOSTNAME#}'"
