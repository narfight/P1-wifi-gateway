...
#define LANG_ConfLedError "Als de blauwe LED blijft branden, is de configuratie mislukt. Verbind opnieuw met het WiFi-netwerk '{#HOSTNAME#}' om de instellingen aan te passen."
...
#define LANG_OTASUCCESS4 "Als de blauwe LED blijft branden, is de configuratie mislukt en moet u opnieuw verbinding maken met het WiFi-netwerk '{#HOSTNAME#}'"
