...
const char LANG[] = R"=====(
{
    ...
    "ConfLedError" : "Si la LED bleue reste allumée, c'est que le réglage a échoué. Reconnectez vous alors au réseau WiFi '{#HOSTNAME#}' pour corriger les paramètres.",
    "ConfP1H2" : "Option sur le compteur",
    ...
    "ConfReadP1Intr" : "Intervalle de mesure en sec",
    ...
    "OTANSUCCESSNOK" : "Il a eu un problème avec la mise à jour",
    "OTANSUCCESSOK" : "Le micrologiciel a été mis à jour avec succès.",
    "OTASUCCESS1" : "Le module va redémarrer. Cela prend environ 30 secondes.",
    "OTASUCCESS2" : "La LED bleue s'allumera deux fois une fois que le module aura terminé son démarrage.",
    "OTASUCCESS3" : "La LED clignotera lentement pendant la connexion à votre réseau WiFi.",
    "OTASUCCESS4" : "Si la LED bleue reste allumée, la configuration a échoué et vous devrez refaire la connexion avec le réseau WiFi '{#HOSTNAME#}'",
