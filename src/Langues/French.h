...
const char LANG[] = R"=====(
{
    ...
    "ConfLedError" : "Si la LED bleue reste allumée, c'est que le réglage a échoué. Reconnectez vous alors au réseau WiFi 'P1_Setup_xxx' pour corriger les paramètres.",
