...
const char LANG[] = R"=====(
{
    ...
    "OTANOTSUCCESS" : "Il a eu un problème avec la mise à jour",
    ...
    "OTASUCCESS5" : "Si la LED bleue reste allumée, la configuration a échoué et vous devrez refaire la connexion avec le réseau WiFi '{#HOSTNAME#}'",
